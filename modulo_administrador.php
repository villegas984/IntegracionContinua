...
<div class="panel-body">
    ...
    <a href="agregar_producto.php" class="cart-link" title="Agregar producto">Agregar_Producto<i class="glyphicon glyphicon-plus-sign"></i></a>
			...
			<div class="thumbnail">
                <div class="caption">
					...
					<table class="table">
						...
						<tbody>
							<tr>
								<td><textarea name="id" style="width: 30px; max-width: 30px; min-width: 30px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["id"]; ?></textarea></td>
								<td><textarea name="cod_referencia" style="width: 60px; max-width: 60px; min-width: 60px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["cod_referencia"]; ?></textarea></td>
								<td><textarea name="nombre" style="width: 120px; max-width: 140px; min-width: 140px; max-height: 40px; min-height: 40px;"><?php echo $rowT2["nombre"]; ?></textarea></td>
								<td class="" style="max-width: 150px;"><?php echo '<p class="imagen_dimen" style="background-image: url('."'".$rowT2["imagen"]."'".'); background-repeat: no-repeat; border-radius: 5px; margin:auto;"></p>'; ?><label for="imagen"></label><input type="file" href="editarProducto.php" name="imagen" size="20"></td>
								<td><textarea name="precio" style="width: 90px; max-width: 90px; min-width: 70px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["precio"]; ?></textarea></td>
								<td><textarea name="descripcion" style="width: 120px; max-width: 140px; min-width: 140px; max-height: 40px; min-height: 40px;"><?php echo $rowT2["descripcion"]; ?></textarea></td>
								<td><textarea name="stock" style="width: 40px; max-width: 40px; min-width: 40px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["stock"]; ?></textarea></td>
								<td><textarea name="talla" style="width: 40px; max-width: 40px; min-width: 40px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["talla"]; ?></textarea></td>
								<td><textarea name="color" style="width: 80px; max-width: 80px; min-width: 80px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["color"]; ?></textarea></td>
								<td><textarea name="genero" style="width: 40px; max-width: 40px; min-width: 40px; max-height: 30px; min-height: 30px;"><?php echo $rowT2["genero"]; ?></textarea></td>
								<td><input type="submit" href="editarProducto.php" class="btn btn-success" Value="Editar" style="align-content: center;"><input type="submit" href="editarProducto.php" class="btn btn-danger" Value="Eliminar" name="Eliminar" onclick="return confirm('Confirma eliminar?')" style="align-content: center; margin-top: 2px;"></td>
								<td></td>
							</tr>
						</tbody>
					</table>				
...
?>		
 ...
 <div class="panel-footer"><span styles="margin: 0 10px;"><b>Tienda de Zapatos G16</b><br> 
