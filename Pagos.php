...
<div class="panel-body">
    ...
    <div class="shipAddr">
		...
		<?php 
		if(empty($custRow) || $custRow == null){
			print "<p>Por favor inicie sesión o regístrese para continuar con el pago...</p>";
		} else {
		
		?>
		<b>Edita o conserva los datos para el envío:</b>
		</br>
		</br>
		</br>
        <p><b>Nombre:</b><textarea style="width: 100px; max-width: 100px; min-width: 100px; max-height: 23px; min-height: 23px;"><?php echo $custRow['nombre']; ?></textarea></p>
        <p><b>Correo:</b><textarea style="width: 200px; max-width: 200px; min-width: 200px; max-height: 23px; min-height: 23px;"><?php echo $custRow['correo']; ?></textarea></p>
        <p><b>Celular:</b><textarea style="width: 200px; max-width: 200px; min-width: 200px; max-height: 23px; min-height: 23px;"><?php echo $custRow['celular']; ?></textarea></p>
        <p><b>Dirección:</b><textarea style="width: 200px; max-width: 200px; min-width: 200px; max-height: 23px; min-height: 23px;"><?php echo $custRow['direccion']; ?></textarea></p>
		<?php } ?>
    </div>
    <div class="footBtn">
